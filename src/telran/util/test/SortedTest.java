...
//	-5, 10, 15 100, 120, 134, 280, 
	...
	void floorTest() {
		...
		assertEquals(15, sorted.floor(20));
		assertEquals(280, sorted.floor(300));
		assertEquals(100, sorted.floor(115));
	}
	@Test
	void ceilingTest() {
		assertEquals((Integer)100, sorted.ceiling(100));
		assertNull(sorted.ceiling(281));
		assertEquals(15, sorted.ceiling(13));
		assertEquals(-5, sorted.ceiling(-10));
		assertEquals(280, sorted.ceiling(150));
	}
	
	@Test
	void firstTest() {
		assertEquals(-5, sorted.first());
	}
	@Test
	void lastTest() {
